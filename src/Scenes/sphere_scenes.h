#ifndef SPHERE_SCENES_H
#define SPHERE_SCENES_H
...
void two_spheres(HittableList& scene, Camera& camera){
...
void material_spheres(HittableList& scene, Camera& camera){
...
void bouncing_spheres(HittableList& scene, Camera& camera){
