...
void five_planes(HittableList& scene, Camera& cam){
    // Materials
...
void coloured_triangles(HittableList& scene, Camera& cam){
    // Materials
    auto left_red     = make_shared<Lambertian>(Color(1.0, 0.2, 0.2));
    auto back_green   = make_shared<Lambertian>(Color(0.2, 1.0, 0.2));
    auto right_blue   = make_shared<Lambertian>(Color(0.2, 0.2, 1.0));
    ...
    // Triangles
    scene.add(make_shared<Quad>(Point3(-2,-2, 0), Vec3(4, 0, 0), Vec3(0, 4, 0), back_green));
    scene.add(make_shared<Triangle>(Point3(-3,-2, 0), Vec3(-3, 2, 0), Vec3(-5, 0,2), left_red));
    scene.add(make_shared<Triangle>(Point3( 3,-2, 0), Vec3(5, 0, 2), Vec3(3, 2, 0), right_blue));
    scene.add(make_shared<Triangle>(Point3(-2, 3, 0), Vec3(2,3,0), Vec3(0, 5, 2), upper_orange));
    scene.add(make_shared<Triangle>(Point3(-2,-3, 0), Vec3(0, -5, 2), Vec3(2, -3,0), lower_teal));
